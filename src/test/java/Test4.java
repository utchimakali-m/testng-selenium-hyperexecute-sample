...
public class Test4 {
    ...
    public void testSetUp(String browser, String version, String platform, String resolution) throws Exception {
        ...
        ltOptions.put("build", "[HyperExecute - 4] Demonstration of the TestNG Framework");
        ltOptions.put("name", "[HyperExecute - 4] Demonstration of the TestNG Framework");
    ...
    public void test4_element_addition_1() throws InterruptedException {
        ExtentTest test1 = extent.createTest("demo application test 4-1", "To Do App test 1");
